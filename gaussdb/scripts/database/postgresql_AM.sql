...
CREATE TABLE IDN_OAUTH2_ACCESS_TOKEN (
			...
			PRIMARY KEY (ACCESS_TOKEN),
            FOREIGN KEY (CONSUMER_KEY) REFERENCES IDN_OAUTH_CONSUMER_APPS(CONSUMER_KEY) ON DELETE CASCADE,
            CONSTRAINT CON_APP_KEY UNIQUE (CONSUMER_KEY, AUTHZ_USER,USER_TYPE,TOKEN_STATE,TOKEN_STATE_ID,TOKEN_SCOPE,ACCESS_TOKEN)
);
...
CREATE TABLE AM_API_URL_MAPPING (
    ...
    URL_PARAMETERS VARCHAR(1024) NULL,
    REQUEST_BODY VARCHAR(1024) NULL,
    RESPONE_BODY VARCHAR(1024) NULL,
